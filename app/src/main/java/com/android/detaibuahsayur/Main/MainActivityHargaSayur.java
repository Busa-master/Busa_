...
public class MainActivityHargaSayur extends AppCompatActivity {
    ...
    private void showRecyclerList() {
        ...
        ListBuahAdapter listsayuradapter = new ListBuahAdapter(list);
        rvBusa.setAdapter(listsayuradapter);

        listsayuradapter.setOnItemClickCallback(new ListBuahAdapter.OnItemClickCallback() {
            @Override
